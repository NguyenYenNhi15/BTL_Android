...
public class DBHeplper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql = " INSERT INTO SINHVIEN VALUES ('B19KH001','Nguyen Van A','nguyenvan@gmail.com','avatasinhvien','Android','KHMT')";
        db.execSQL(sql);
        sql = " INSERT INTO SINHVIEN VALUES ('B20KT001','Nguyen Van A','nguyenvanb@gmail.com','avatasinhvien','Kinhte','KETOAN')";
        db.execSQL(sql);
        sql = " INSERT INTO SINHVIEN VALUES ('B17CN005','Nguyen Thi C','c@gmail.com','avatamacdinh','Toan','CNTT')";
        db.execSQL(sql);
        //tạo table taikhoan
